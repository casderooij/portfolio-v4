...
<a
	...
	class="bg-white z-10 top-0 underline left-0 self-start border border-black px-2 py-1 overflow-hidden truncate font-mono text-mono-mobile text-[#00f] focus:z-20"
